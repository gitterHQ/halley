...
function Client(endpoint, options) {
  ...
  this.listenTo(this._dispatcher, 'reconnect:handshake', function() {
    this.transitionState('rehandshake', { optional: true, dedup:true })
      .done();
  });

  this.listenTo(this._dispatcher, 'reconnect:none', function() {
...
Client.prototype = {
  ...
  _onEnterHANDSHAKE_WAIT: function() {
    ...
    debug('Waiting %sms before rehandshaking', intervalValue);
